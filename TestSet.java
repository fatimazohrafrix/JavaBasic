...
public class TestSet {
    public static void main(String[] args) {
        ...
        set1.add("ABC2");
        set1.add("ABC3");
        set1.add("ABC1"); // ne s'affiche pas
        set1.add("ABC4");
        set1.add("ABC5");
        ...
        set2.add(new Client(1,"ALAMI"));
        set2.add(new Client(2,"SOUHAIL")); // maintenant on a redefini les methodes equals & hashcode pour comparer les objets avec le code et le nom
...
//        set4.forEach(i-> System.out.println(i));
        ...
        System.out.println("--------------------compare set4------------------------------");
        ...
        set4.add(new Client(2,"HASSAN"));
        set4.add(new Client(3,"SAID"));
        set4.add(new Client(2,"HASSAN")); // already exist !
        set4.forEach(i-> System.out.println(i));
